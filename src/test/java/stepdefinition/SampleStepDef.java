...
public class SampleStepDef {
    ...
    public void iCreateCompanyInTheSystem() {
        ...
        Response response=given().relaxedHTTPSValidation().baseUri("https://agilecrm.s3.amazonaws.com/")
                .contentType(ContentType.MULTIPART)
                .multiPart("file", new File("/Users/harshad_dange/Desktop/sample.png"), "image/*")
                .header("Accept", "*/*")
